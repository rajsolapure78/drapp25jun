...
class GluscoseTrackerTile extends StatefulWidget {
  ...
  const GluscoseTrackerTile({Key? key, required this.glucoseItem})
      : super(key: key);
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Text("Last 3 Readings",
                        style:
                            TextStyle(fontSize: constraints.maxWidth * 0.043)),
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Column(children: [
                            Stack(children: [
                              SizedBox(
                                ...
                                child: Image.network(
                                    'https://www.rsolutions7.com/drmohan/images/onetouch.png'),
                              ),
                              Positioned(
                                left: constraints.maxWidth * 0.090,
                                top: constraints.maxHeight * 0.039,
                                child: Text(
                                  widget.glucoseItem != null &&
                                          widget.glucoseItem.length > 0
                                      ? num.parse(
                                              widget.glucoseItem.first.Value1)
                                          .round()
                                          .toString()
                                      : "-",
                                  style: TextStyle(
                            ...
                            Text(
                                widget.glucoseItem != null &&
                                        widget.glucoseItem.length > 0
                                    ? widget.glucoseItem.first.Date
                                        .split(" ")[1]
                                    : "-",
                                style: TextStyle(
                                    fontSize: constraints.maxWidth * 0.0435)),
                          ]),
                          Column(children: [
                            Stack(children: [
                              SizedBox(
                              ...
                              Positioned(
                                ...
                                child: Text(
                                    widget.glucoseItem != null &&
                                            widget.glucoseItem.length > 1
                                        ? num.parse(
                                                widget.glucoseItem[1].Value1)
                                            .round()
                                            .toString()
                                        : "-",
                                    style: TextStyle(
                            ...
                            Text(
                                widget.glucoseItem != null &&
                                        widget.glucoseItem.length > 1
                                    ? widget.glucoseItem[1].Date.split(" ")[1]
                                    : "-",
                                style: TextStyle(
                                    fontSize: constraints.maxWidth * 0.0435)),
                          ]),
                          Column(children: [
                            Stack(children: [
                              ...
                              Positioned(
                                ...
                                child: Text(
                                  widget.glucoseItem != null &&
                                          widget.glucoseItem.length > 2
                                      ? num.parse(widget.glucoseItem[2].Value1)
                                          .round()
                                          .toString()
                                      : "-",
                                  style: TextStyle(
                            ...
                            Text(
                                widget.glucoseItem != null &&
                                        widget.glucoseItem.length > 2
                                    ? widget.glucoseItem[2].Date.split(" ")[1]
                                    : "-",
                                style: TextStyle(
                                    fontSize: constraints.maxWidth * 0.0435)),
                          ]),
  ...
  List<PieSeries<PieChartData, String>> _getPieSeries() {
    return <PieSeries<PieChartData, String>>[
      PieSeries<PieChartData, String>(
          ...
          radius: '125%',
          xValueMapper: (PieChartData d1, _) => d1.x,
          yValueMapper: (PieChartData d2, _) => d2.y,
          pointColorMapper: (PieChartData d3, _) => d3.color,
