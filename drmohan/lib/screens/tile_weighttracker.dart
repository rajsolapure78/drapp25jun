...
class WeightTrackerTile extends StatefulWidget {
  ...
  const WeightTrackerTile({Key? key, required this.weightItem}) : super(key: key);
      ...
      child: LayoutBuilder(builder: (BuildContext context, BoxConstraints constraints) {
        ...
        return Card(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
            ...
            Text(
              "Underweight",
              style: TextStyle(fontWeight: FontWeight.bold, color: Colors.lightBlue, fontSize: constraints.maxWidth * 0.052),
